          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                  <div className="text-3xl mb-4">??</div>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">{stats.notifications}</div>
                  <div className="text-gray-600 dark:text-gray-400">Notifications</div>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                  <div className="text-3xl mb-4">??</div>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">{stats.messages}</div>
                  <div className="text-gray-600 dark:text-gray-400">Unread Messages</div>
                </div>
              </div>
              
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Welcome to your Dashboard!</h3>
                <p className="text-gray-600 dark:text-gray-400">You are now logged in as {user?.name || 'User'}.</p>
              </div>
            </div>
          )}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-xl font-semibold text-gray-900 dark:text-white">{user?.name || 'User'}</p>
